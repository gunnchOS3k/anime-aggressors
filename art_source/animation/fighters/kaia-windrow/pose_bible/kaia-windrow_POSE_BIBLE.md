...
1. Open `source/kaia-windrow_control_rig.blend` (when LFS source is present).
2. Pose deform or FK controls. Screenshot orthographic front + side.
3. Drop stills in this folder as `kaia-windrow_<slot>_front.png`.
