# Pose Bible — Orion Vell

**Status:** TEMPLATE ONLY. Not human-authored. `AUTHORED_POSE_BIBLE_PASS=false`.

- Fighter: `orion-vell`
- Lane: gravity / trap
- Identity: Delayed breath. Measured walk. Sink before launch.
...
1. Open `source/orion-vell_control_rig.blend` (when LFS source is present).
2. Pose deform or FK controls. Screenshot orthographic front + side.
3. Drop stills in this folder as `orion-vell_<slot>_front.png`.
