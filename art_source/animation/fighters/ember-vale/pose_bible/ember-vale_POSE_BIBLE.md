# Pose Bible — Ember Vale

**Status:** TEMPLATE ONLY. Not human-authored. `AUTHORED_POSE_BIBLE_PASS=false`.

- Fighter: `ember-vale`
- Lane: flame / rush
- Identity: Tempo-first. Restless weight. Rush-through attacks.
...
1. Open `source/ember-vale_control_rig.blend` (when LFS source is present).
2. Pose deform or FK controls. Screenshot orthographic front + side.
3. Drop stills in this folder as `ember-vale_<slot>_front.png`.
