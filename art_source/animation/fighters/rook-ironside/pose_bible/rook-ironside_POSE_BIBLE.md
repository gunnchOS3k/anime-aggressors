...
1. Open `source/rook-ironside_control_rig.blend` (when LFS source is present).
2. Pose deform or FK controls. Screenshot orthographic front + side.
3. Drop stills in this folder as `rook-ironside_<slot>_front.png`.
