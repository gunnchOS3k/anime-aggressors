# Pose Bible — Juno Spark

**Status:** TEMPLATE ONLY. Not human-authored. `AUTHORED_POSE_BIBLE_PASS=false`.

- Fighter: `juno-spark`
- Lane: volt / trick
- Identity: Staccato resets. Light broken-rhythm walk. Fast recover.
...
1. Open `source/juno-spark_control_rig.blend` (when LFS source is present).
2. Pose deform or FK controls. Screenshot orthographic front + side.
3. Drop stills in this folder as `juno-spark_<slot>_front.png`.
