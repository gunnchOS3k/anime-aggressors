...
export function startPaintFloor(canvas: HTMLCanvasElement) {
  ...
  trackGamepads((pads, dt) => {
    ...
    // Player 1 movement
    if (p1.axes[0] < -0.5 && players[0].x > 0) players[0].x--;
    if (p1.axes[0] > 0.5 && players[0].x < cols - 1) players[0].x++;
    if (p1.axes[1] < -0.5 && players[0].y > 0) players[0].y--;
    if (p1.axes[1] > 0.5 && players[0].y < rows - 1) players[0].y++;
    
    // Player 2 movement
    if (p2.axes[0] < -0.5 && players[1].x > 0) players[1].x--;
    if (p2.axes[0] > 0.5 && players[1].x < cols - 1) players[1].x++;
    if (p2.axes[1] < -0.5 && players[1].y > 0) players[1].y--;
    if (p2.axes[1] > 0.5 && players[1].y < rows - 1) players[1].y++;
