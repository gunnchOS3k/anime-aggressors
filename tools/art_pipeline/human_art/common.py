...
# Automation must never set these true. Prefix is not authority.
# Documentary/source gates such as CANDIDATE_RIGHTS_READY are not in this list.
OWNER_QUALITY_GATES = (
    ...
    "MERGE_AUTHORIZED",
    "HUMAN_ROSTER_ART_DIRECTION_PASS",
    "HUMAN_ROSTER_SILHOUETTE_PASS",
    "HUMAN_ROSTER_ANIMATION_QUALITY_PASS",
    "HUMAN_ROSTER_COMBAT_FEEL_PASS",
    "HUMAN_ROSTER_HURT_READ_PASS",
    "HUMAN_ROSTER_SUPER_PASS",
    "HUMAN_ROSTER_CLASH_PASS",
    "HUMAN_ROSTER_MOBILE_READ_PASS",
    "HUMAN_ROSTER_CLIP_WORTHY_PASS",
    "HUMAN_ELEMENTAL_IDENTITY_PASS",
    "HUMAN_SPECIALS_QUALITY_PASS",
    "HUMAN_HIT_REACTION_PASS",
    "HUMAN_VFX_QUALITY_PASS",
    "HUMAN_PIXEL_REVIEW_PASS",
    "OWNER_SELECT_COLOR_APPROVAL",
    "OWNER_MATCH_COLOR_APPROVAL",
    "OWNER_ROSTER_ROYGBIV_APPROVAL",
)

DOCUMENTARY_PROVENANCE_GATES = (
    "CANDIDATE_RIGHTS_READY",
    "SOURCE_KNOWN",
    "RIGHTS_DECLARATION_PRESENT",
    "GENERATED_EXPERIMENT_NOT_SELECTED_PASS",
)

STRUCTURAL_CANDIDATE_GATES = (
    "FULL_ROSTER_HUMAN_CANDIDATE_CONTRACT_PASS",
    "FULL_ROSTER_HUMAN_CANDIDATES_COMPLETE",
    "FULL_ROSTER_VALIDATOR_PASS",
    "FULL_ROSTER_MANIFEST_PASS",
)

DEPRECATED_GATE_ALIASES = {
    "HUMAN_CANDIDATE_RIGHTS_READY": "CANDIDATE_RIGHTS_READY",
}
...
def candidate_rights_ready(row: dict) -> bool:
    if not isinstance(row, dict):
        return False
    if "CANDIDATE_RIGHTS_READY" in row:
        return bool(row.get("CANDIDATE_RIGHTS_READY"))
    return bool(row.get("HUMAN_CANDIDATE_RIGHTS_READY"))
