"""Build one v7 polished fighter and export the runtime GLB. No voxel remesh."""
...
from generated_art_v7.body_profiles import as_v5_body, style_profile  # noqa: E402
from generated_art_v7.boot_builder import build_boots  # noqa: E402
from generated_art_v7.cel_materials import apply_review_color_management, assign, build_materials, paint_undersuit  # noqa: E402
from generated_art_v7.costume_masses import build_costume  # noqa: E402
from generated_art_v7.export_runtime import export_glb, report_payload  # noqa: E402
from generated_art_v7.glove_builder import build_gloves  # noqa: E402
from generated_art_v7.hero_poses import overlay_table  # noqa: E402
...
def build_v7_fighter(fid: str, p, arm):
    ...
    if any(mod.type == "REMESH" for obj in meshes for mod in obj.modifiers):
        raise RuntimeError("v7 must not use remesh modifiers")
...
def _overlay_v7_hero_poses(fid: str, arm) -> None:
...
def build(fid: str, out_blend: Path, out_glb: Path, skip_anim: bool) -> dict:
    ...
    body, costume, geom = build_v7_fighter(fid, p, arm)
    _link(mesh_col, body)
    for obj in costume:
        _link(mesh_col, obj)
    ...
    if not skip_anim:
        _overlay_v7_hero_poses(fid, arm)
