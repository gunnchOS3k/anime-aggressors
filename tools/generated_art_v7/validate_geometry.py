"""v7 geometry/construction gates. File existence is not a visual pass."""
from __future__ import annotations

import json

from generated_art_v7.body_profiles import FIGHTER_IDS, ROOT
from generated_art_v7.render_review import REQUIRED_SHOTS, ROSTER_SHEETS
...
def validate() -> dict:
    ...
    payload = {
        "ok": loft and gloves and boots and masks and masses and suit and hero and not remesh,
        "GEN_ART_V7_NO_VOXEL_REMESH": loft and not remesh,
        "GEN_ART_V7_STYLE_LOCK_DIGITAL": style and loft,
        "GEN_ART_V7_FULL_SUIT_COVERAGE_DIGITAL": suit,
        "GEN_ART_V7_GLOVE_READ_DIGITAL": gloves,
        "GEN_ART_V7_BOOT_READ_DIGITAL": boots,
        "GEN_ART_V7_MASK_HEAD_READ_DIGITAL": masks,
        "GEN_ART_V7_COSTUME_MASS_DIGITAL": masses,
        "GEN_ART_V7_HERO_FEATURE_DIGITAL": hero,
        "triangle_budget_ok": tris_ok,
        "roster_sheets": sheets,
        "fighters": fighters,
    }
    REPORTS.mkdir(parents=True, exist_ok=True)
    (REPORTS / "GENERATED_ART_V7_GEOMETRY.json").write_text(json.dumps(payload, indent=2) + "\n")
    return payload
