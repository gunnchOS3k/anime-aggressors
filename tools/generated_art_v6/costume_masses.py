...
def build_costume(profile: StyleProfile, arm_obj, mats: dict):
    ...
    if fid == "ember-vale":
        ...
        sl_h, sl_t = bone_pts(arm_obj, "Shoulder_L")
        sr_h, sr_t = bone_pts(arm_obj, "Shoulder_R")
        add(box_mesh("scarf_collar", nt + Vector((0.0, 0.03, 0.0)), (0.16, 0.10, 0.08)), "accent")
        add(box_mesh("scarf_fall", nt + Vector((0.04, 0.06, -0.10)), (0.07, 0.10, 0.20)), "accent")
        add(box_mesh("airfoil_l", sl_t + Vector((0.04, 0.02, 0.06)), (0.08, 0.04, 0.16)), "accent")
        add(box_mesh("airfoil_r", sr_t + Vector((-0.04, 0.02, 0.06)), (0.08, 0.04, 0.16)), "accent")
    elif fid == "nix-calder":
