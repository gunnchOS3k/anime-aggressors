...
from generated_art_v8.body_profiles import FIGHTER_IDS, ROOT, load_palettes, luma, palette_value_ok
from generated_art_v8.hero_poses import idle_v8, pose_delta_ok, pose_v8
from generated_art_v8.impact_pair_solver import geometry_ok
...
def _contact_row(fid: str) -> dict:
    ...
    return (payload.get("contact") or {}).get("heavy_contact_pair_off") or {}
...
def inspect() -> dict:
    ...
    for fid in FIGHTER_IDS:
        ...
        idle = pose_delta_ok(idle_v8(fid), pose_v8("ember-vale", "idle") if fid != "ember-vale" else pose_v8("rook-ironside", "idle"), ("Hips", "Chest", "Head", "UpperArm_R", "UpperArm_L", "UpperLeg_R"))
        hurt = pose_delta_ok(idle_v8(fid), pose_v8(fid, "hurt_peak"), ("Head", "Chest", "Hips", "UpperArm_R", "UpperLeg_R"))
        charge = pose_delta_ok(idle_v8(fid), pose_v8(fid, "charge"), ("Chest", "Head", "Hips", "UpperArm_R", "UpperArm_L"))
        super_p = pose_delta_ok(idle_v8(fid), pose_v8(fid, "super"), ("UpperArm_R", "UpperArm_L", "Chest", "Hips"))
        clash = pose_delta_ok(idle_v8(fid), pose_v8(fid, "clash_lock"), ("Chest", "UpperArm_R", "UpperArm_L", "UpperLeg_R", "UpperLeg_L"))
    ...
    payload = {
        ...
        "generator": "aa_generated_art_v8",
        "generator_version": "8.0.0",
        "human_authored": False,
        "GEN_ART_V8_NO_PEACH_BODY_DIGITAL": peach_ok,
        "GEN_ART_V8_VALUE_BLOCKING_DIGITAL": values_ok and nix_ok,
        "GEN_ART_V8_DETAIL_CAMERA_DIGITAL": camera_ok,
        "GEN_ART_V8_HEAVY_PAIR_TWO_FIGURES_DIGITAL": pair_ok,
        "GEN_ART_V8_PAIR_CONTACT_GEOMETRY_DIGITAL": contact_ok,
        "GEN_ART_V8_IDLE_IDENTITY_DIGITAL": idle_ok,
        "GEN_ART_V8_HURT_ACTING_DIGITAL": hurt_ok,
        "GEN_ART_V8_CHARGE_TRANSFORM_DIGITAL": charge_ok,
        "GEN_ART_V8_SUPER_HERO_POSE_DIGITAL": super_ok,
        "GEN_ART_V8_CLASH_ACTING_DIGITAL": clash_ok,
        "GEN_ART_V8_MOBILE_READ_DIGITAL": mobile_ok,
        "GEN_ART_V8_HERO_FEATURE_DIGITAL": hero_ok,
    ...
    (REPORTS / "GENERATED_ART_V8_QUALITY.json").write_text(json.dumps(payload, indent=2) + "\n")
    return payload
