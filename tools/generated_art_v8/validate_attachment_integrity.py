...
from generated_art_v8.attachment_map import classify_name  # noqa: E402
from generated_art_v8.body_profiles import FIGHTER_IDS, load_attachment_table  # noqa: E402
...
OUT = REPORTS / "GENERATED_ART_V8_ATTACHMENT_INTEGRITY.json"
...
def _posed_blender() -> dict:
    ...
    script = ROOT / "tools/generated_art_v8/blender/gp_validate_attachments.py"
    ...
    for fid in FIGHTER_IDS:
        ...
        if not blend.is_file():
            ...
            continue
        out = REPORTS / f"GENERATED_ART_V8_ATTACHMENT_{fid}.json"
        proc = subprocess.run(
...
def validate() -> dict:
    ...
    payload = {
        ...
        "GEN_ART_V8_ATTACHMENT_INTEGRITY_PASS": not fails and unintentional == 0,
