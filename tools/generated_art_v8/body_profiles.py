"""v8 profiles. v6 style lock + v5 loft remain the understructure."""
...
PALETTE_PATH = ROOT / "game-godot/data/art/generated_v8/palette_blocking.json"
PAIR_PATH = ROOT / "game-godot/data/art/generated_v8/pair_matchups.json"
ATTACH_PATH = ROOT / "game-godot/data/art/generated_v8/attachment_classes.json"
STYLE_LOCK_V8 = ROOT / "docs/art/GENERATED_ART_V8_RIGGED_COSTUME.md"
...
def load_palettes(path: Path | None = None) -> dict:
    ...
    _reject_human(payload, "v8 palettes")
