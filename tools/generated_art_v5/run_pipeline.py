#!/usr/bin/env python3
"""Run generated art v5 loft pipeline. Does not merge. Does not set HUMAN_*."""
...
from generated_art_v5.body_profiles import FIGHTER_IDS  # noqa: E402
from generated_art_v5.emit_gates import main as emit_gates  # noqa: E402
from generated_art_v5.export_runtime import write_glb_import  # noqa: E402
from generated_art_v5.make_roster_sheets import main as make_sheets  # noqa: E402
from generated_art_v5.validate_geometry import validate as validate_geom  # noqa: E402
from generated_art_v5.write_az_report import main as write_az  # noqa: E402
...
def generate_masters() -> dict:
    ...
    script = ROOT / "tools/generated_art_v5/blender/gp_build_v5.py"
    render = ROOT / "tools/generated_art_v5/blender/gp_render_v5.py"
    reports = {}
    v5_dir = ROOT / "artifacts/vxp3/review/generated_art_v5"
...
def _write_camera_rollup() -> dict:
    ...
    write_json(REPORTS / "REVIEW_CAMERA_ORIENTATION_V5.json", out)
    return out
...
def main() -> int:
    ...
    write_json(REPORTS / "GENERATED_ART_V5_MASTERS.json", masters)
    _write_camera_rollup()
    try:
        sheets = make_sheets()
    except Exception as exc:  # noqa: BLE001 — sheet compose is optional
        sheets = {"ok": False, "reason": str(exc)}
    write_json(REPORTS / "GENERATED_ART_V5_SHEETS.json", sheets)
