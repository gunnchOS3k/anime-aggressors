...
from generated_art_v9.render_review import REQUIRED_SHOTS, ROSTER_SHEETS
...
def validate() -> dict:
    ...
    payload = {
        ...
        "GEN_ART_V9_NO_VOXEL_REMESH": loft and not remesh,
        "GEN_ART_V9_STYLE_LOCK_DIGITAL": style and loft,
        "GEN_ART_V9_FULL_SUIT_COVERAGE_DIGITAL": suit,
        "GEN_ART_V9_GLOVE_READ_DIGITAL": gloves,
        "GEN_ART_V9_BOOT_READ_DIGITAL": boots,
        "GEN_ART_V9_MASK_HEAD_READ_DIGITAL": masks,
        "GEN_ART_V9_COSTUME_MASS_DIGITAL": masses,
        "GEN_ART_V9_HERO_FEATURE_DIGITAL": hero,
        "GEN_ART_V9_ATTACHMENT_RECORDS_DIGITAL": attached,
        "triangle_budget_ok": tris_ok,
        "roster_sheets": sheets,
        "fighters": fighters,
    }
    REPORTS.mkdir(parents=True, exist_ok=True)
    (REPORTS / "GENERATED_ART_V9_GEOMETRY.json").write_text(json.dumps(payload, indent=2) + "\n")
    return payload
