...
const SCENES := {
	...
	"team": "res://scenes/menus/TeamScene.tscn",
	"challenges": "res://scenes/menus/ChallengesScene.tscn",
	"online_hub": "res://scenes/menus/OnlineHubScene.tscn",
	"tournament": "res://scenes/menus/TournamentScene.tscn",
