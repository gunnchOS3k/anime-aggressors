...
static func animation_for_state(s: String) -> String:
	match s:
		...
		DASH: return "dash"
		TURNAROUND: return "turn"
		JUMP_SQUAT: return "jump_start"
		JUMP, DOUBLE_JUMP: return "jump_rise"
		FALL, FAST_FALL: return "fall"
		...
		SHIELD_HOLD, SHIELD_STUN: return "shield_hold"
		DODGE_START, DODGE_ACTIVE: return "dodge_forward"
		AIR_DODGE: return "air_dodge"
		GRAB_STARTUP, GRAB_ACTIVE: return "grab"
		...
		LAUNCHED: return "critical_launch"
		KO: return "ko"
		RESPAWN: return "respawn"
		VICTORY: return "victory"
		DEFEAT: return "defeat"
		EDGE_WARNING, LEDGE_TEETER: return "ledge_hang"
