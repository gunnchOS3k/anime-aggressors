...
const CASES := [
	...
	{"name": "dash_attack", "cmd": "attack_dash", "expect_move": "dash_attack", "expect_clip": "dash_attack"},
	...
	{"name": "side_special", "cmd": "special_forward", "expect_move": "side_special", "expect_clip": "side_special"},
	{"name": "up_special", "cmd": "special_up", "expect_move": "up_special_recovery", "expect_clip": "recovery"},
	{"name": "down_special", "cmd": "special_down", "expect_move": "down_special", "expect_clip": "down_special"},
