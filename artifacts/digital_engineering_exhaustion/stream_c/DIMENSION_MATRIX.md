...
|---|---|---|---|
| build | PASS | Godot project import/load |  |
| launch | PASS | godot --headless --quit-after 1 |  |
| save_load | PARTIAL | test:game-core / persistence tests | HUMAN_VALIDATION_REQUIRED |
| menus | PARTIAL | res://tests/smoke_runner.gd | HUMAN_VALIDATION_REQUIRED |
